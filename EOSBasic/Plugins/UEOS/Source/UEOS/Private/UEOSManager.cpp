...
UEOSConnect* UEOSManager::GetConnect()
{
	if (UEOSManager::EOSManager->Connect == nullptr)
	{
		UEOSManager::EOSManager->Connect = NewObject<UEOSConnect>(UEOSManager::EOSManager);
	}
